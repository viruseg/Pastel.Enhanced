...
Pastel.Enhanced is an extension library for [Pastel](https://github.com/silkfire/Pastel) that provides a set of methods for primitive types that allow them to be output to the console using color and bypassing the toString() method call.
